...
class PatientDetailDialog(QDialog):
    ...
    class MedicationDialog(QDialog):
        def __init__(self, config_manager, medication_data=None, parent=None):
            super().__init__(parent)
        ...
        def _setup_ui(self):
            ...
            # Button text depends on whether we're adding or editing
            ok_text = "Save Changes" if self.medication_data else "Add Medication"
    ...
    def _setup_ui(self):
        ...
        self.export_report_btn = QPushButton("Export Medical Report")
        self.export_report_btn.clicked.connect(self._export_medical_report)
    ...
    def _add_medication(self):
        ...
        dialog = self.MedicationDialog(self.config_manager, None, self)  # Pass None for new medication
        result = dialog.exec_()
    ...
    def _edit_medication(self, row=None, column=None):
        ...
        # Show the medication dialog
        dialog = self.MedicationDialog(self.config_manager, medication_data, self)
        result = dialog.exec_()
